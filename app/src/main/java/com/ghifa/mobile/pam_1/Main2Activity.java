...
import com.ghifa.mobile.pam_1.fragment.jumat;
import com.ghifa.mobile.pam_1.fragment.kamis;
...
//        });
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.senin) {
            ...
            transaksiFragment.replace(R.id.drawer_kontent, selasa);

        } else if (id == R.id.rabu) {

            rabu rabu = new rabu();
            transaksiFragment.replace(R.id.drawer_kontent, rabu);

        } else if (id == R.id.kamis) {

            kamis kamis = new kamis();
            transaksiFragment.replace(R.id.drawer_kontent, kamis);

        } else if (id == R.id.jumat) {

            jumat jumat = new jumat();
            transaksiFragment.replace(R.id.drawer_kontent, jumat);
